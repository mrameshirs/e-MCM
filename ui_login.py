...
def login_page():
    ...
    ">
        ...
        <p style="font-size: 1.1em;">The application is currently undergoing maintenance to resolve a Google Drive integration issue. We are working to restore full functionality as soon as possible.</p>
        <p>This is likely due to a permissions setting on the Shared Drive. Please ensure the app's service account has been added as a 'Content manager'.</p>
